...
function addVideoPlaceholdersForPMS(pms, containerElement) { 
    ...
    switch (pms) {
        case "Julie":
            videoPlaceholderHTML = `
                <video controls class="video-placeholder">
                    <source src="../public/videos/Julie_gateway.mp4" type="video/mp4">
        ...
        case "Logosw":
            videoPlaceholderHTML = `
                <video controls class="video-placeholder">
                    <source src="../public/videos/Logosw.mp4" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
                <video controls class="video-placeholder">
                    <source src="../public/videos/Allisone_v2_acquisition.mp4" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
            `;
            break;
